<div class="col-sm-9 col-sm-offset-3 col-lg-16 col-lg-offset-2 main"> 
    <div class="row">
        <ol class="breadcrumb">
            <li><a href="#"><span class="glyphicon glyphicon-home"></span></a>
            </li> <li>Master Data Admin</li>
                    ...
                    <form action="<?php echo base_url('admin/simpan-admin'); ?>" method="post">
                        <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                'abcdefghijklmnopqrstuvwxyz_ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890', this)" name="username" placeholder="Masukkan Username Admin" required="required">
                            </div>
                            <div style="clear:both;"></div>
                            ...
                            <div class="form-group col-md-6"> 
                                ...
                                <select class="form-control" name="level" required="required"> 
                                    ...
                                    <option value="3">Admin Perpustakaan</option> </select>
                            </div>
                            <div style="clear: both;"></div>
